...
namespace redisclient
{
    ...
    int64_t RedisValue::toInt64() const
    {
    ...
    {
        return typeEqual<NullTag>();
    }

    bool RedisValue::isInt() const
    {
        return typeEqual<int64_t>();
    }

    bool RedisValue::isString() const
    {
        return typeEqual<std::vector<char>>();
    }
    ...
    {
        return typeEqual<std::vector<RedisValue>>();
    }
